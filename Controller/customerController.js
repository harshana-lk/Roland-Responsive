...
export class CustomerController {
  constructor() {
    ...
    $(".btn-save").click(this.handleSaveCustomer.bind(this));
    $("#table_body").click(this.handleTblCustomer.bind(this));
    $(".btn-clear").click(this.clearCustomer.bind(this));
  ...
  handleSaveCustomer(e) {
    ...
    if (!this.custIdPattern.test(custID)) {
      ...
      $("#duplicateError").text("Use C-001  Format");
      return;
    }
    $("#duplicateError").text("");
    ...
    $("#addressError").text("");
    saveCustomer(new Customer(custID, fName, lName, address))
  ...
  handleUpdateCustomer(e) {
    ...
    updateCustomer(new Customer(custID, fName, lName, address))
